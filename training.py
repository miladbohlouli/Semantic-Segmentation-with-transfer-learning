...
def train_epoch(model, data_loader, optimizer, criterion, scheduler, args):
...
def eval_epoch(model, data_loader, criterion, class_labels, valid_labels, maskColors, epoch, folder, args):
